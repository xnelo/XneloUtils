...
XNELO_TEST_CASE(UDPSocketTests, UDPSocket_SendData)
{
	...
	XNELO_TEST_ASSERT_EQUAL(udpA->SendData(addrA, (void*)dataA, dataASize), dataASize, "UDPSocket sends data successfully");
	...
	XNELO_TEST_ASSERT_EQUAL(XNELO::CORE::strcmp_s(dataA, dataASize, dataB, dataBSize), 0, "Data sent correctly");
